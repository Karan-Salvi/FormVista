          ...
          <form className="space-y-5" onSubmit={handleSignup}>
            <div>
              ...
              <input
                type="text"
                required
                className="focus:ring-acc w-full rounded-xl border border-gray-300 bg-white px-4 py-3.5 transition-all outline-none focus:border-transparent focus:ring-2"

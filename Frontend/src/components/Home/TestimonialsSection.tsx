...
export const TestimonialsSection = () => {
  return (
    <section className="w-full bg-background py-24 relative overflow-hidden">
      <div className="container z-10 mx-auto sm:px-6">
        <motion.div
        ...
        >
          <div className="flex justify-center mb-6">
            <div className="border border-slate-200 py-1.5 px-4 rounded-full text-xs font-bold uppercase tracking-wider text-primary bg-primary/5">
              Testimonials
            </div>
          </div>
